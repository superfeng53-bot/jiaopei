    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-700">
      ...
      <header className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-6 text-sm font-medium text-slate-500">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-white border border-slate-200 rounded-lg shadow-sm hover:border-blue-200 hover:text-blue-600 transition-all group"
          >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          {/* Left Column: Intro - Hidden on mobile, subtle on desktop */}
          <div className="hidden lg:col-span-4 lg:flex flex-col space-y-8 pt-10">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100 shadow-sm">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900">多模态分析</h3>
                  <p className="text-[10px] text-slate-500">支持 PDF, Word, 图片等多种格式</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-slate-100 shadow-sm">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900">上下文增强</h3>
                  <p className="text-[10px] text-slate-500">结合历史反馈，生成更具连续性的建议</p>
                </div>
              </div>
            </div>
          </div>

          {/* Right Column: Wizard - Full width on mobile */}
